...
export function About() {
  return (
    <div className="flex flex-1 flex-col text-gray-700 w-full h-screen items-center justify-center gap-6 p-4">
      ...
      <Typography variant="h5">Source code is available on <a
        className="font-medium text-green-500 dark:text-green-blue-600 hover:underline" target="_blank" rel="noreferrer"
        href="https://github.com/dborodin836/TF2-GPTChatBot">GitHub</a></Typography>
