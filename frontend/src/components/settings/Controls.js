...
export function Controls(props) {
    return <Card className="flex border rounded-none shadow-none flex-row p-4 gap-6">
        <div role="button" onClick={props.onClick} tabIndex="0"
        ...
        <div role="button" onClick={props.onClick1} tabIndex="0"
        ...
        <div role="button" onClick={props.onClick2} tabIndex="0"
