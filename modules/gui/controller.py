...
from modules.command_controllers import GuiCommandController, shared_config
...
from modules.commands.gui.confirmations import confirm
...
command_controller.register_command("c", confirm, "Confirm command by name. e.g. c <command name>")
